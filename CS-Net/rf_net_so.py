...
class RFNetSO(RFNetModule):
    def __init__(self, det, des, SCORE_W, PAIR_W, PSIZE, TOPK):
        ...
        self.det.conv_o3_1.apply(self.det.convO_init)
        self.det.conv_o3_2.apply(self.det.convO_init)
        self.det.conv_o3_3.apply(self.det.convO_init)
        self.det.conv_o3_4.apply(self.det.convO_init)
        self.det.conv_o3_5.apply(self.det.convO_init)
        self.det.conv_o5_1.apply(self.det.convO_init)
        self.det.conv_o5_2.apply(self.det.convO_init)
        self.det.conv_o5_3.apply(self.det.convO_init)
        self.det.conv_o7_1.apply(self.det.convO_init)
        self.det.conv_o7_2.apply(self.det.convO_init)
    ...
    def forward(self, batch):
        ...
        endpoint = {
            ...
            "im1_topkmask": im1_topkmask,
            "im2_topkmask": im2_topkmask,
        }
